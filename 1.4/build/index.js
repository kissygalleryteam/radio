...
gallery/radio/1.4/index

*/
/**
 * @fileoverview radio 美化组件
 * @author bofang.zxj<bofang.zxj@taobao.com>
 * @module radio
 **/
KISSY.add('gallery/radio/1.4/index',function(S, Node, Base) {
    var $ = Node.all;
    /**
     * @name Radio
...
//            self.fire(self.get('events').RENDER);
        ...
        ATTRS: /** @lends radio.prototype*/
        {
            ...
            /**
             * css模块路径
             * @default gallery/radio/1.4/radio/style.css
             */
            cssUrl: {
                value: 'gallery/radio/1.4/style.css'
            },
            /**
             * 是否需要label for的对应
             * @default false
